# Task: reconstruction of distance-matrix from distance-matrix using variationa-autoencoder
import sys
sys.path.append("../")
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch % test_every == 0:
            ...
            if val_loss < best_test_loss:
                ...
                torch.save(model.state_dict(), 'outputs/models/vae_cmap_recon_{}.pth'.format(ith_start))
