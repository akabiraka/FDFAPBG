...
#SBATCH --output=/scratch/akabir4/project_dir/outputs/logs/recon_distmap_using_vae_log_1-%N-%j.output
#SBATCH --error=/scratch/akabir4/project_dir/outputs/logs/recon_distmap_using_vae_log_1-%N-%j.error
